...
* **Visual Studio Code:** Used as the primary integrated development environment (IDE) for writing code and managing files.
* **Git & GitHub:** Used for local version control and remote repository hosting.
* **macOS Terminal / zsh:** Used for navigating directory paths and executing scripts directly from the command line.

* **Python 3:** Selected for its clean syntax, rapid setup, and immediate console output capabilities.
